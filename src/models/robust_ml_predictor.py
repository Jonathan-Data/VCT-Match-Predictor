...
class RobustVCTPredictor:
    ...
    def load_and_process_all_data(self):
        ...
        # Tournament chronological mapping for temporal features
        tournament_dates = {
    ...
    def create_comprehensive_features(self):
        ...
        # Process matches chronologically to build rolling features
    ...
    def _get_team_primary_region(self, team, historical_data):
        ...
        # Most common region (excluding International)
    ...
    def implement_temporal_splits(self, features, labels, test_size=0.2, val_size=0.15):
        ...
        # Combine with match info for temporal sorting
    ...
    def train_and_validate_models(self):
        ...
        # Define models with basic hyperparameter ranges
        model_configs = {
            'random_forest': {
        ...
        # Train ensemble from top 2 models
        ...
        # Train ensemble on combined train+validation data
    ...
    def evaluate_final_performance(self):
        ...
        for name, model in self.calibrated_models.items():
            ...
            try:
                ...
                calibration_error = 0.1  # Default calibration error
    ...
    def predict_match(self, team1, team2):
        ...
        try:
            # Create features for this match using all historical data
