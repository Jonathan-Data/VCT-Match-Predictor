...
class DualSourceMLPredictor:
    ...
    def __init__(self, data_dir=None):
        ...
        # Initialize dual-source components
    ...
    def collect_and_integrate_data(self) -> bool:
        ...
        try:
            ...
            # Collect unified data from both sources
    ...
    def prepare_training_data(self, match_data: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            for match in match_data:
                ...
                # Convert UnifiedTeamStats to dict format for feature engineering
    ...
    def train_enhanced_model(self) -> bool:
        ...
        try:
            ...
            rf_space = {
                'n_estimators': Integer(200, 800),  # Increased for 58+ features
                'max_depth': Integer(10, 40),       # Deeper for complex feature interactions
            ...
            rf_bayes = BayesSearchCV(
                ...
                rf_space,
                n_iter=60,  # More iterations for complex feature space
                cv=tscv,
                scoring='roc_auc',
                n_jobs=-1,
                random_state=42
            ...
            gb_space = {
                'n_estimators': Integer(200, 1200),  # More estimators for complex features
            ...
            # 3. Optimize MLP for high-dimensional features
            ...
            mlp_space = {
                ...
                'hidden_layer_sizes': Categorical([
                    ...
                    (150, 100, 50), (200, 150, 75)  # Deeper networks for complex features
                ]),
            ...
            mlp_bayes = BayesSearchCV(
                ...
                mlp_space,
                n_iter=40,
                cv=3,  # Reduced CV for neural networks
                scoring='roc_auc',
                n_jobs=-1,
                random_state=42
            )
            ...
            # Enhanced meta-learner with L2 regularization
    ...
    def predict_match_enhanced(self, team1: str, team2: str, 
        ...
        try:
            ...
            team1_prob = proba[1]  # Class 1 = team1 wins
            team2_prob = proba[0]  # Class 0 = team2 wins
            ...
            # Enhanced confidence levels with calibrated probabilities
            if confidence >= 0.95:
...
def main():
    ...
    # if predictor.collect_and_integrate_data():
