...
class AdvancedVCTPredictor:
    def __init__(self, data_dir=None):
        ...
        # Enhanced model ensemble with calibration
        ...
        # Calibrated models for improved confidence
        self.calibrated_models = {}
        self.ensemble_model = None
        self.scaler = StandardScaler()
        self.label_encoder = LabelEncoder()
        
        # Enhanced data storage with temporal information
        self.team_stats = {}
        self.player_stats = {}
    ...
    def load_comprehensive_data_with_temporal_info(self):
        ...
        # Tournament chronological order for temporal splitting
        tournament_order = {
        ...
        for tournament_dir in self.data_dir.iterdir():
            if tournament_dir.is_dir() and 'csvs' in tournament_dir.name:
                ...
                try:
                    # Load matches with temporal info
                    ...
                    # Load all additional data types
        ...
        # Combine and sort by date for temporal consistency
        if all_matches:
        ...
        # Store tournament timeline for temporal analysis
    ...
    def create_enhanced_features_with_temporal_context(self):
        ...
        # Sort matches by date for temporal feature calculation
    ...
    def _create_comprehensive_match_features(self, team1, team2, match_date, tournament, historical_data):
        ...
        # Historical data up to this match
            ...
            if len(team_history) > 0:
                ...
                if len(recent_matches) > 0:
                    ...
                    for i, match in enumerate(recent_matches.iterrows()):
                        weight = 0.9 ** (len(recent_matches) - i - 1)  # More weight to recent
                ...
                if len(team_history) > 0:
                    ...
                    features[f'{prefix}_days_since_last'] = min(days_since, 180)  # Cap at 6 months
                else:
                    features[f'{prefix}_days_since_last'] = 180
                
            else:
                # No history available - use neutral values
    ...
    def implement_proper_data_splits(self, features, labels, test_size=0.2, val_size=0.15):
        ...
        # For temporal data, use time-based splitting to simulate real prediction scenarios
    ...
    def hyperparameter_tuning_with_validation(self):
        ...
        mlp_grid = GridSearchCV(
            ...
            mlp_params,
            cv=3,  # Smaller CV for neural networks
            scoring='accuracy',
            n_jobs=-1,
            verbose=0
        )
    ...
    def train_advanced_ensemble_with_calibration(self):
        ...
        # Train ensemble on combined train+validation data for final model
    ...
    def evaluate_on_test_set(self):
        ...
        best_model_name = max(results.keys(), 
                             ...
                             else results[k]['accuracy'] + 0.005)  # Slight bias toward ensemble
    ...
    def predict_match_with_enhanced_confidence(self, team1, team2):
        ...
        try:
            ...
            current_tournament = "VCT Champions 2025"  # Assume current context
...
def main():
    ...
    # Step 1: Load comprehensive data with temporal info
